    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransactionEventId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransactionEvents", x => x.TransactionEventId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_OrderReference",
                table: "Transactions",
